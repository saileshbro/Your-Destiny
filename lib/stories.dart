    ...
    pages: [
      SPage(
        ...
        choices: [
          ...
          Choice(
            choice: 'Better ask him if he\'s a murderer first...',
            pageIndex: 1,
          )
        ],
      ),
      SPage(
        ...
        choices: [
          ...
          Choice(
            choice: '"Wait, I know how to change a tire!"',
            pageIndex: 3,
          )
        ],
      ),
      ...
      SPage(
        ...
        choices: [
          Choice(choice: 'Restart', pageIndex: null),
        ],
      ),
      SPage(
        pageIndex: 4,
  ...
  Story(
    ...
    pages: [
      ...
      SPage(
        ...
        choices: [
          Choice(
            choice: 'Go back to the mailbox to find out',
            pageIndex: 0,
          ),
        ],
      ),
      SPage(
        ...
        choices: [
          Choice(
            choice: 'Drive up to the dock to find out who sent you the letter',
            pageIndex: 3,
          )
        ],
      ),
      SPage(
        ...
        choices: [
          ...
          Choice(
            choice: 'Run away as fast as you can',
            pageIndex: 5,
          ),
        ],
      ),
